...
public class GameMessagesCreator {
    ...
    public SnakesProto.GameMessage createSteerMsg(Course course, int senderId, long msgSeq) {

        SnakesProto.Direction spDirection = CourseConverter.getInstance().directionToSnakesProto(course);
