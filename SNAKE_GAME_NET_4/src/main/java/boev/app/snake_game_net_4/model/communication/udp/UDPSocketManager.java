...
class UDPSocketManager {
    ...
    void send(DatagramSocket socket, Message message) throws IOException {
        ...
        DatagramPacket msgPacket = new DatagramPacket(buff, buff.length, message.getSocket().inetAddress(), message.getSocket().port());
    ...
    Message receive(DatagramSocket socket) throws IOException {
        ...
        return new Message(gameMessage, new MySocket(datagram.getAddress(), datagram.getPort()), 0);
    }
}
